...
## Clinical Pathology SARS-CoV-2 Test Report `r format(Sys.Date(), '%d %B %Y')` {.tabset .tabset-fade}  
  
### Platform Specimen Summary  
...
Restricted to platforms with >= 4 weeks of recorded data.  
